...
export class SubAreaService {
  ...
  async fetchSubArea(id, orcs, subAreaId, date) {
    ...
    try {
      ...
      this.loggerService.debug('Park GET request started');
  ...
  async fetchRegions(regionId = null) {
    ...
    try {
      if (regionId) {
        this.loggerService.debug('Region GET request started');
        ...
        this.loggerService.debug('Region list GET request started');
  ...
  async fetchSubareasByOrcs(orcs) {
    ...
    try {
      this.loggerService.debug('Subareas list GET request started');
